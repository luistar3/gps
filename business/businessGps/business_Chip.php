...
include_once($_SERVER["DOCUMENT_ROOT"] . '/ps/data/connection.php');
include_once($_SERVER["DOCUMENT_ROOT"] . '/ps/data/data_Evento.php');
include_once($_SERVER["DOCUMENT_ROOT"] . '/ps/complements/funciones.php');
include_once($_SERVER["DOCUMENT_ROOT"] . '/ps/complements/navegador.php');
...
class business_Chip
{
    ...
    public function fncBusinessListarChips(){
		...
		if ($connectionstatus) 
		{
				...
				$sql = "usp_Gpstel_Chip_listarChips";
