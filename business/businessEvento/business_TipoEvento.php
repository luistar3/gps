...
include_once($_SERVER["DOCUMENT_ROOT"] . '/gps/data/data_TipoEvento.php');
...
class business_TipoEvento
{

    public function fncBusinessListarTipoEventos(){
